...
$(document).ready(function(){
		 ...
		 */
         ...
         $.ajax({
			...
			error: function (error) {
				console.log(error);
				$("#resultX").stop().fadeOut("slow",function(){ $(this).html("<h4 style='color:red;padding:3em;'>ERROR!!! <br> Facebook crashed <br> Place Search API is deprecated for third parties effective v8.0 is deprecated for versions v8.0 and higher</h4>")}).fadeIn(2000);
            }	
        });
	...
	//FB application ID
	//var MY_CONSTANT_APP_ID = '3102******'; //moved to Credentials!!!!

    //var MY_CONSTANT_APP_ID = '29820*********'; //outdated
		...
		*/
        ...
        $.ajax({
            ...
            success: function(data) {
				...
				alert("ajax SESSION started for User ID -> " + data.userX);
